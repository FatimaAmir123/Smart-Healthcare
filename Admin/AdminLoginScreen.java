...
public class AdminLoginScreen extends JFrame {
    ...
    private static final String VALID_USER = "farah_a";
    private static final String VALID_PASS = "admin123";

    public AdminLoginScreen() {
        setTitle("Smart Portal — Admin Login");
        ...
        JLabel sub = new JLabel("Admin Portal Access", SwingConstants.CENTER);
        ...
        JLabel hint = new JLabel("Hint: " + VALID_USER + " / " + VALID_PASS, SwingConstants.CENTER);
        ...
        login.addActionListener(e -> {
            ...
            if (VALID_USER.equals(user) && VALID_PASS.equals(pass)) {
                transitioning = true;
                dispose();
                SwingUtilities.invokeLater(() -> HospitalAdmin.main(new String[0]));
            } else {
