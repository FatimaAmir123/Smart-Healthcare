...
public class doctorSchedulePanel extends JPanel {
    ...
    private void openEditAppointmentDialog(String time, String[] data) {
        ...
        if (alreadyAccepted) {
            ...
            acceptBtn.addActionListener(e -> {
                ...
                JOptionPane.showMessageDialog(dialog,
                    "email and sms have been sent to " + fPatient, "Accepted", JOptionPane.INFORMATION_MESSAGE);
                dialog.dispose();
            });
            ...
            rejectBtn.addActionListener(e -> {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(dialog,
                        "email and sms have been sent to " + fPatient, "Rejected", JOptionPane.INFORMATION_MESSAGE);
                    dialog.dispose();
                }
            });
                    ...
                    if (alreadyAccepted) {
                        ...
                        acceptBtn2.addActionListener(e -> {
                            ...
                            JOptionPane.showMessageDialog(doctorSchedulePanel.this,
                                "email and sms have been sent to " + fp2, "Accepted", JOptionPane.INFORMATION_MESSAGE);
                            refreshAll();
                        });
                        ...
                        rejectBtn2.addActionListener(e -> {
                            ...
                            if (confirm == JOptionPane.YES_OPTION) {
                                ...
                                JOptionPane.showMessageDialog(doctorSchedulePanel.this,
                                    "email and sms have been sent to " + fp2, "Rejected", JOptionPane.INFORMATION_MESSAGE);
                                refreshAll();
                            }
                        });
    ...
    private JPanel buildWeeklyView() {
        ...
        delBtn.addActionListener(e -> {
            ...
            refreshAll();
            JOptionPane.showMessageDialog(doctorSchedulePanel.this,
                "email and sms have been sent to " + patient, "Cancelled", JOptionPane.INFORMATION_MESSAGE);
        });
        btnBar.add(delBtn);
